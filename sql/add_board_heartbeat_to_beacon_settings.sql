...
-- beacon_settings so the app and a scheduled check can tell when the shop
-- beacon board has gone offline.
--
...
--
-- offline_alert_sent debounces the "board is offline" email so it only
